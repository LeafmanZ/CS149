...
public class EightBall {
    ...
    /**
    * Takes input questions and return random answers.
    *
    ...
    */
    ...
    public static void main(String[] args) {
        ...
        String  wantToAsk = "yes";   // User input: want to ask a question
        ...
        boolean isSixty = true;     // Check if its 60 or not
            ...
            while (isSixty) {
                ...
                if (questionStr.length() > 60) {
                    System.out.print("Your question is too long." 
                        + "Be more concise.\n");
                } else if (questionStr.length() < 2) {
                    System.out.print("That is not allowed.\n");
                } else if (questionStr.indexOf("?") 
                    != questionStr.length() - 1) {
                    System.out.print("Please add a ? mark.\n");
                } else {
                    isSixty = false;
                }
            }
